...
export const aboutdata:AboutDataLocalized =
{
    EN: [
        ...
        <ul>
            <li> We believe in the importance of play.</li>
            <li> We believe in handcrafted, human-made art.</li>
            <li> We believe in the magic of storytelling.</li>
        </ul>    
    ...
    ES: [
        ...
        <ul>
            <li> Creemos en la importancia del juego.</li>
            <li> Creemos en el arte hecho a mano, por humanos.</li>
            <li> Creemos en la magia de contar historias.</li>
        </ul>    
    ...
    FR:[
        ...
        <ul>
            <li> Nous croyons en l’importance du jeu.</li>
            <li> Nous croyons en l’art fait main, par des humains.</li>
    ...
    JP:[
        ...
        <ul>
            <li> 私たちは、遊びの大切さを信じています。</li>
            <li> 私たちは、人の手による手作りのアートを信じています。</li>
