...
const Footer = () => {
  ...
  return (
    ...
    //     <div id='language-container' onClick={ () => { toggleLanguage(true) } }>
    //       <div id='launguage-container-wrapper'>
    //         <div id='language-btn' className='show-selector'>
    //           <svg className='language-logo' version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 900">	          
    ...
    //           </svg>
    //           <p id='language-text'>{FooterTerms[language].languageText}</p>
    //         </div>
