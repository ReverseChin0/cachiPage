...
import { FooterTerms } from '../data/navData';
...
const Footer = () => {
  ...
  const toggleLanguage = (show:boolean) => {
    ...
    const langBtn = document.getElementById("change-language-btn");
  ...
  return (
    <div className="footer">
        <div className="footer-max-content">

            <div className="footer-element footer-purple">
                <p className="footer-text">© LightWitch All rights reserved.</p>
            </div>

            <div className="footer-element wrapper" id="toggleWrapper">
                <div className=" overlayed" id="change-language-btn">
                    <svg onClick={ () => { toggleLanguage(true) } } className='language-logo' version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 900">	          
                    ...
                    <p className='spaced-text' onClick={ () => { toggleLanguage(true) } } >{FooterTerms[language].languageText}</p>
                </div>
                <div className=" overlayed hidden" id="language-selector">
            ...
            <div className="footer-element justify-items-end footer-purple">
                <p>{FooterTerms[language].illustrationBy}</p>
            </div>
